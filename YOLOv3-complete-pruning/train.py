...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            s = ('%10s' * 2 + '%10.3g' * 6) % (
                '%g' % (epoch), '%.3g' % mem, *mloss, len(targets), img_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=376)  # 500200 batches at bs 16, 117263 images = 273 epochs
    ...
    parser.add_argument('--data', type=str, default='data/CCTSDB.data', help='*.data file path')
    ...
    parser.add_argument('--prune', type=int, default=2, help='0:nomal prune or regular prune 1:shortcut prune 2:tiny prune')
